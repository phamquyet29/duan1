...
<div class="min-h-screen p-7 leading-loose mx-auto max-w-full">
  <form method="post" action="<?= BASE_URL . 'pay-cart'?>" class="max-w-7xl p-4 mx-auto bg-white rounded shadow-xl">
    ...
    <div class="py-4">
     ...
     <textarea class="w-full px-2 py-2 border-gray-500 border-[1px] border-solid text-gray-700 bg-gray-100 rounded forcus:border-red" name="note" id="" cols="30" rows="5"></textarea>
